...
export const metadata = {
  title: "Contact | Moonlit Match",
  description:
    "Contact Moonlit Match with questions about the site, compliance pages, or affiliate content.",
};
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#070712] text-white">
      ...
      <section className="relative mx-auto min-h-screen max-w-4xl px-6 py-8 sm:px-8 lg:px-10">
        ...
        <div className="mt-16 rounded-[2rem] border border-white/10 bg-white/10 p-8 backdrop-blur sm:p-10">
          <Mail className="mb-5 text-purple-300" />
          <h1 className="text-4xl font-bold tracking-tight">Contact</h1>
          <div className="mt-6 space-y-5 text-sm leading-7 text-white/65 sm:text-base">
            <p>
              For questions about Moonlit Match, compliance pages, or affiliate
              content, contact us at{" "}
              <a
                href="mailto:hello@moonlitmatch.com"
                className="text-pink-300 transition hover:text-purple-200"
              >
                hello@moonlitmatch.com
              </a>
              .
            </p>
            <p>
              If your question is about a purchase, account, refund, or product
              delivery from a third-party reading or sketch platform, please
              contact that platform directly.
            </p>
          </div>
        </div>
      </section>
